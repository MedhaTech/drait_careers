...
<div class="container-fluid">
    ...
    <?php } ?>
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label text-right font-weight-bold">Post title</label>
                <div class="col-sm-4">
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo (set_value('title')) ? set_value('title') : $details->title; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    echo form_dropdown('type', $courseTypeOpt,  set_value('type', $details->type), 'class="form-control" id="type"'); ?>
           ...
           $ayList = array(" "=>"- Select -", "2023-24" => "2023-24", "2024-25" => "2024-25", "2025-26" => "2025-26");
            		      	echo form_dropdown('ay', $ayList, set_value('ay', $details->ay),'class="form-control"'); 
            		      ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" name="description" id="description" class="form-control" value="<?php echo (set_value('description')) ? set_value('description') : $details->description; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" name="fee" id="fee" class="form-control" value="<?php echo (set_value('fee')) ? set_value('fee') : $details->fee; ?>">
            ...
            <div class="custom-control custom-checkbox mb-3">
                    <input type="checkbox" class="custom-control-input" id="status" value="1" name="status" <?php echo ($details->status)?'checked':'';?>>
