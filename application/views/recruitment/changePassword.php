    ...
    <div class="card-body">
    	...
    	<?php echo form_open($action, 'class="user"'); ?>
		  ...
		  <div class="form-group row">
		    <label for="staticEmail" class="col-sm-2 col-form-label text-right font-weight-bold">User Name : </label>
		    <div class="col-sm-10">
		      <input type="text" name="username" id="username" class="form-control col-sm-8" value="<?php echo (set_value('username'))?set_value('username'):$Details->username;?>" readonly>
		      <span class="validationError"><?php echo form_error('username'); ?></span>
		    </div>
		  </div>
