                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control"><?php echo (set_value('description')) ? set_value('description') : $details->description; ?></textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                ...
                                echo form_dropdown('type', $courseTypeOpt, $details->type, 'class="form-control" id="type"'); ?>
                        ...
                        <?= form_label('Departments:', 'departments[]') ?>
                            <select name="departments[]" class="form-control" multiple="multiple">
                                ...
                                {
                                    $departments1 = explode(',', $details->departments);
                                    ?>
                                  <?php $selected = in_array($dep->id,$departments1) ? " selected " : null;?>
