        ...
        <div class="card-body pd-y-20">
          ...
          <div class="form-row mg-b-10">
            ...
            <div class="form-group col-md-12">
              <label class="tx-14 font-weight-bold">Address for Communication </label>
              <input type="text" class="form-control" placeholder="Enter Address for Communication" id="number" name="number" value="<?php echo (set_value('number')) ? set_value('number') : ''; ?>">
              <?= form_error('number', '<div class="text-danger">', '</div>'); ?>
            </div>
            <div class="form-group col-md-4">
              <label class="tx-14 font-weight-bold">Email</label>
              <input type="email" class="form-control" placeholder="Enter Email" id="email" name="email" value="<?= set_value('email'); ?>">
              <?= form_error('email', '<div class="text-danger">', '</div>'); ?>
            </div>

            <div class="form-group col-md-4">
              <label class="tx-14 font-weight-bold">Contact Number</label>
              <input type="text" class="form-control" placeholder="Enter Contact Number" id="contact_number" name="contact_number" value="<?= set_value('contact_number'); ?>">
          ...
          <table class="table table-hover text-dark">
            <thead>
              <tr>
                ...
                <th width='15%'>Address for Communication</th>
            ...
            if ($details) {
              foreach ($details as $details1) {
                ...
                echo '<td>' . $details1->contact_number . '</td>';
              ...
              echo '<tr><td colspan="6" class="text-center text-muted">No References added yet.</td></tr>';
            }
            ?>
          </table>
        </div>
