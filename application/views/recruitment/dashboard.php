            ...
            <div class="card shadow my-2">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <?php
                        if ($details->menu_flag >= 7)
                            echo anchor('recruitment/dashboard#Projects', 'Projects');
                        else
                            echo anchor('recruitment/dashboard#Projects', 'Projects', 'class="btn disabled"');
                        ?>
                    </li>
                    <li class="list-group-item">
                        <?php
                        if ($details->menu_flag >= 7)
                            echo anchor('recruitment/dashboard#Consultancy', 'Consultancy');
                        else
                            echo anchor('recruitment/dashboard#Consultancy', 'Consultancy', 'class="btn disabled"');
                        ?>
                    </li>
                    <li class="list-group-item">
                        <?php
                        if ($details->menu_flag >= 7)
                            echo anchor('recruitment/dashboard#Seminars', 'Seminars');
                        else
                            echo anchor('recruitment/dashboard#Seminars', 'Seminars', 'class="btn disabled"');
                        ?>
                    </li>
                    <li class="list-group-item">
                        <?php
                        if ($details->menu_flag >= 7)
                            echo anchor('recruitment/dashboard#Membership', 'Professional Membership');
                        else
                            echo anchor('recruitment/dashboard#Membership', 'Professional Membership', 'class="btn disabled"');
                        ?>
                    </li>
                    <li class="list-group-item">
                        <?php
                ...
                <div class="card-body">
                    <div class="widgetHead">
                        ...
                        <span tabindex="0" class="add no-outline">
                            <?php
                            if ($details->menu_flag >= 7)
                                echo anchor('recruitment/manageConsultancies', '<i class="fas fa-pencil-alt"></i> Manage Consultancy Undertaken', 'class="font-weight-bold"');
                            else
                                echo anchor('recruitment/manageConsultancies', '<i class="fas fa-pencil-alt"></i> Manage Consultancy Undertaken', 'class="font-weight-bold btn disabled"'); ?>
                        </span>
                    </div>
                    <table class="table table-hover text-dark">
                        <thead>
                ...
                <div class="card-body">
                    <div class="widgetHead">
                        ...
                        <span tabindex="0" class="add no-outline">
                            <?php
                            if ($details->menu_flag >= 7)
                                echo anchor('recruitment/manageSeminarsWorkshopsCourses', '<i class="fas fa-pencil-alt"></i> Manage Seminars / Workshop / Short-term Course', 'class="font-weight-bold"');
                            else
                                echo anchor('recruitment/manageSeminarsWorkshopsCourses', '<i class="fas fa-pencil-alt"></i> Manage Seminars / Workshop / Short-term Course', 'class="font-weight-bold btn disabled"'); ?>
                        </span>
                    </div>
                    <table class="table table-hover text-dark">
                        <thead>
