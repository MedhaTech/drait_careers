            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                	...
                	<?php echo form_open($action, 'class="user"'); ?>
					  ...
					  <div class="form-group row">
            		    <label for="staticEmail" class="col-sm-3 col-form-label text-right font-weight-bold">For the Post of</label>
            		    <div class="col-sm-9">	
						<select name="post_id" id="post_id" class="form-control col-sm-6" required>	
						
								
				
								</select>
            		      <span class="validationError"><?php echo form_error('post_id'); ?></span>
            		    </div>
            		  </div>
            		  <div class="form-group row">
