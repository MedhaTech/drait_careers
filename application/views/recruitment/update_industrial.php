             ...
             <div class="card ht-100p shadow">
               <div class="card-body pd-y-20">      
                    ...
                    <div class="widgetHead mb-3">
                        <span class="widgetTitle">Update Industrial Experience</span>
                    </div>  
                ...
                <div class="form-row mg-b-10">
                    <div class="form-group col-md-5">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Name of the Organization" id="organization" name="organization" value="<?php echo (set_value('organization'))?set_value('organization'):$details->organization;?>">
                      <?=form_error('organization','<div class="text-danger">','</div>');?>
                    </div>
                    <div class="form-group col-md-3">
                      <label class="tx-14 font-weight-bold">Position Held</label>
                      <input type="text" class="form-control" placeholder="Enter Position Held" id="position_held" name="position_held" value="<?php echo (set_value('position_held'))?set_value('position_held'):$details->position_held;?>">
                ...
                <div class="col-md-12 text-right">
                    ...
                    <?php echo anchor('recruitment/manageIndustrial','Cancel','class="btn btn-secondary btn-square btn-sm"'); ?>    
                </div>
