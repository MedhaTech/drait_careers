                ...
                <div class="widgetHead mb-3">
                    <span class="widgetTitle">List of Teaching Experiences</span>
                     <span tabindex="0" class="add no-outline">
                            <?php 
                             if(($user_data->menu_flag==5) && (count($details)>1))
                             {
                                echo anchor('recruitment/profile?flag=6','<i class="fas fa-angle-double-right "></i> Save & Proceed','class="btn btn-block btn-success btn-square btn-sm"');
                             }
                             elseif(($user_data->menu_flag==5))
                             {
                                echo anchor('recruitment/profile?flag=6','<i class="fas fa-angle-double-right "></i> Skip & Proceed','class="btn btn-block btn-success btn-square btn-sm"');
                             }
                             else
                             {
