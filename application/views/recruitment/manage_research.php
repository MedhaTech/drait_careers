              ...
              <div class="card-body pd-y-20">
                <div class="widgetHead mb-3">
                    ...
                    <span tabindex="0" class="add no-outline">
                            <?php 
                             if(($user_data->menu_flag==3))
                             {
                                echo anchor('recruitment/dashboard?flag=4','<i class="fas fa-angle-double-right "></i> Save & Proceed','class="btn btn-block btn-success btn-square btn-sm"');
                             }
                            ?>
                        </span>
                </div> 
