            ...
            <div class="card ht-100p shadow">
                <div class="card-body pd-y-20">
                    ...
                    <div class="widgetHead mb-3">
                        <span class="widgetTitle">Add New Sponsored Project</span>
                    </div>

                    <?=form_open($action, 'class="js-validation-login push-50" name="form" novalidate'); ?>
                    <div class="form-row mg-b-10">
                        <div class="form-group col-md-3">
                            <label class="tx-14 font-weight-bold">Sponsoring Agency</label>
                            <input type="text" class="form-control" placeholder="Enter Sponsoring Agency" id="sponsoring_agency" name="sponsoring_agency" value="<?php echo (set_value('sponsoring_agency')) ? set_value('sponsoring_agency') : ''; ?>">
                            <?=form_error('sponsoring_agency', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="form-group col-md-3">
                ...
                <div class="card-body pd-y-20">
                    <div class="widgetHead mb-3">
                        ...
                        <span tabindex="0" class="add no-outline">
                            ...
                            if(($user_data->menu_flag == 2) && (count($details) > 0)) {
                                echo anchor('recruitment/dashboard?flag=3', '<i class="fas fa-angle-double-right "></i> Save & Proceed', 'class="btn btn-block btn-success btn-square btn-sm"');
                            }
                            ?>
                        </span>
                    </div>
                    ...
                    <table class="table table-hover text-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                <?=anchor('recruitment/updateProject/'.$details1->id, 'Edit', 'class="btn btn-info btn-square btn-sm mx-1 my-1"')?>
                                <?=anchor('recruitment/deleteProject/'.$details1->id, 'Delete', 'class="btn btn-danger btn-square btn-sm mx-1 my-1"')?>
                            </td>
                        </tr>
                        <?php } ?>
                    </table>
