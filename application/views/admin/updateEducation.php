    	...
    	<?php
    		if(!empty($facultyEducation)){
    			...
    			foreach ($facultyEducation as $facultyEducation1) {
    				echo "<tr>";
    				echo "<td>".$i++."</td>";
    				echo "<td>".$facultyEducation1->education."</td>";
    				echo "<td>".anchor('admin/delEducation/'.$facultyEducation1->id.'/'.$fid,'<i class="fas fa-times"></i>','class="text-danger"')."</td>";
    				echo "</tr>";
    			}
    			echo "</table>";
    		}else{
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
    	...
    	<div class="form-group row">
		    <label for="staticEmail" class="col-sm-3 col-form-label text-right font-weight-bold">Education : </label>
		    <div class="col-sm-9">
		      <textarea class="form-control col-sm-9" rows="5" id="education" name="education"></textarea>
		      <span class="validationError"><?php echo form_error('education'); ?></span>
		    </div>
		</div>
		<div class="form-group row">
