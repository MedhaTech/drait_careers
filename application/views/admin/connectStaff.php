  ...
  <div class="row">
  	<div class="col-md-12">
  		<div class="card shadow mb-4">
			...
			<h6 class="m-0 font-weight-bold text-primary">Connect - Send SMS to Staff</h6>
		  </div>
		  <div class="card-body">
			<?=form_open($action);?>
			<div class="row">
			 		...
			 		<div class="form-group">
						...
						<div class="col-md-12 mt-3">
							<div class="form-group">
					    		...
					    		<?php echo form_dropdown('dept_id',$deptsDropdown, $dept_id,'class="form-control form-control-sm" id="dept_id"'); ?>
						  	...
						  	<div class="form-group">
								<div class="col-md-12">
								<label class="font-weight-bold">Staff Type</label>
								<?php 
									echo form_dropdown('staff_type', $staff_type_dropdown,  $staff_type, 'class="form-control form-control-sm" id="staff_type"'); ?>
